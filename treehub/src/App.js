...
function Edit(){
  ...
  return(
    ...
    <section className="Edit_right">
      ...
      <SaveImage top={top} firstLeft={firstL} firstRight={firstR} secondLeft={secondL} secondMiddle={secondM} secondRight={secondR} bottomLeft={bottomL} bottomMidLeft={bottomML} bottomMidRight={bottomMR} bottomRight={bottomR}/>
    </section>
    </>
  );
}
